PROGRAM MULTIMODEFLOQUET
  ...
  OPEN(UNIT=1,file="DRESSEQUBIT_BAREBASIS_old.dat", action="write")
  OPEN(UNIT=2,file="DRESSEQUBIT_dressedBASIS_old.dat", action="write")
  ...
  DO r=1,32
     FIELDS(3)%omega     = FIELDS(2)%X/4.0 + (r-1)*FIELDS(2)%X/32.0
