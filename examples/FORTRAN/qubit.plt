...
set output "qubitbarevsdressed.eps"
set origin 0,0
set size 1,1.8
set multiplot
set pm3d at b map
...
unset key
set xlabel "Time"
set ylabel "Frequency (x 10^2 {/Symbol w}_0)" offset 0.5,0
set xrange [0:1600]
set xtics 0,400
set yrange [3.5:10]
set ytics 4,2
...
set origin 0,0.85
set size 1,1
set label "(a)" at -300,10.5 front textcolor rgbcolor "black" font "Helvetica,25"
splot "qubit_bareoscillation.dat" u 2:(1E2*$1):4

unset label
set origin 0,0
set size 1,1
set label "(b)" at -300,10.5 front textcolor rgbcolor "black" font "Helvetica,25"
splot "qubit_dressedoscillation.dat" u 2:(100*$1):4
unset multiplot
unset output
...
set ytics 4,2
set cbtics 0,0.2
set label "(a)" at 100,9 front textcolor rgbcolor "black" font "Helvetica,36"
unset colorbox
...
set ytics 4,2
set cbtics 0,0.2
set label "(b)" at 100,9 front textcolor rgbcolor "white" font "Helvetica,36"
