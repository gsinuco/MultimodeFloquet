...
PROGRAM MULTIMODEFLOQUET
  ...
  OPEN(UNIT=3,FILE="qubit_noise_oscillation_SP.dat",ACTION="WRITE")
  ...
  DO m=1,128
     ...
     !--- EVALUATE THE AVERAGE TRANSITION PROBABILITIES IN THE BARE BASIS
     P_AVG = 0.0
