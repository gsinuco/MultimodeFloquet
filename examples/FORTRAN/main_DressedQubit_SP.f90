PROGRAM MULTIMODEFLOQUET
  ...
  OPEN(UNIT=4,file="qubit_dresseoscillation_SP.dat", action="write")
  ...
  CALL DRESSEDBASIS_SUBSET_SP(ID,DRESSINGFLOQUETDIMENSION,DRESSINGFIELDS,SIZE(MODES_NUM,1),DRESSINGFIELDS_INDICES,MODES_NUM,FIELDS,&
       & U_FD,E_DRESSED,INFO)
