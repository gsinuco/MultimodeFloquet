...
!!$MODULE HAMILTONIANCOMPONENTS
!!$  Public
!!$  INTERFACE
!!$     SUBROUTINE SETHAMILTONIANCOMPONETS(ID,MODES_NUM,FIELD,INFO)
!!$       
!!$       ! ID  tYPE OF ATOM
...
!!$       TYPE(MODE), DIMENSION(:), INTENT(INOUT) :: FIELD
!!$       INTEGER,                  INTENT(INOUT) :: INFO
!!$     END SUBROUTINE SETHAMILTONIANCOMPONETS
!!$  END INTERFACE
!!$END  MODULE HAMILTONIANCOMPONENTS
