...
SUBROUTINE MULTIMODEMICROMOTION_C(D,NM,MODES_NUM,U_F_MODES,E_MULTIFLOQUET,D_BARE,FIELD,T1,U,INFO) 
...
!  COMPLEX*16,       DIMENSION(D_BARE,D),      INTENT(OUT)   :: U_AUX ! TIME-DEPENDENT TRANSFORMATINO BETWEEN THE DRESSED AND EXTENDED BARE BASIS
  ...
  !WRITE(*,*) "ME"
  CALL MULTIMODEMICROMOTION(D,NM,MODES_NUM,U_F_MODES,E_MULTIFLOQUET,D_BARE,COUPLING,T1,U,INFO) 
