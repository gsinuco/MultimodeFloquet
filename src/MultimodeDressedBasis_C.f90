SUBROUTINE DRESSEDBASIS_C(D,ID,NM,MODES_NUM,FIELDS,U_FD,E_DRESSED,INFO)
...
!!$ INFO (INOUT)                 : INFO = 0 MEANS SUCESS
  ...
  CALL DRESSEDBASIS(D,ATOM_,NM,MODES_NUM,COUPLING,U_FD,E_DRESSED,INFO)

END SUBROUTINE DRESSEDBASIS_C


SUBROUTINE DRESSEDBASIS_SUBSET_C(ID,DRESSINGFLOQUETDIMENSION,DRESSINGFIELDS,&
        & NM,DRESSINGFIELDS_INDICES,MODES_NUM,FIELDS,U_FD,E_DRESSED,INFO)
...
!!$ INFO (INOUT)                 : INFO = 0 MEANS SUCESS
  ...
  CALL DRESSEDBASIS_SUSBSET(ATOM_,DRESSINGFLOQUETDIMENSION,DRESSINGFIELDS,&
    & NM,DRESSINGFIELDS_INDICES_,MODES_NUM,COUPLING,U_FD,E_DRESSED,INFO)


END SUBROUTINE DRESSEDBASIS_SUBSET_C
