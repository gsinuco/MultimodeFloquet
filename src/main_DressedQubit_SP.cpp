...
int main(){
  ...
  for(r=0;r<1;r++){
    ...
    multimodefloquetmatrix_sp_c_(&id,&nm,&total_frequencies,modes_num,fields,&info); // in this function we calculate the dimension of the multimode floquet hilbert space, 
    ...
    for(r=0;r<h_floquet_size;r++) printf("%15.5f  ",e_floquet[r]);   // U_F is the transformation that diagonalise the Hamiltonian
