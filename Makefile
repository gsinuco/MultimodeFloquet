...
#all:build/MultimodeFloquetQubit_new build/MultimodeFloquetDressedQubit build/MultimodeFloquetRelease
# build/MultimodeFloquetQubit_new

all: build/MultimodeFloquetQubit_SP Example_lib_sp build/MultimodeFloquetQubit_new Example_lib  build/MultimodeFloquetDressedQubit build/MultimodeFloquetDressedQubit_SP 
...
build/MultimodeFloquetQubit_new:  build/modes.o build/Modules.o build/Modules_release.o build/util.o build/delta_kr.o build/I_and_J_representations.o build/F_representation.o build/Floquet.o build/VarCRSPacking.o build/quick-sort-index-table.o build/sparse_utils.o  build/LapackEigenValues.o build/MultimodeFloquetTE.o build/MultimodeMicroMotion.o build/MultimodeTransitionAVG.o  build/MultimodeHamiltonian.o src/main_qubit.f90 
...
build/MultimodeFloquetTE.o:src/MultimodeFloquetTE.f90
	$(GF) -o $@ -c src/MultimodeFloquetTE.f90 -O3 -g
